...
def create_theme_imgui_light() -> Union[str, int]:
    with dpg.theme() as theme_id:
        with dpg.theme_component(dpg.mvButton, enabled_state=False):
            dpg.add_theme_color(dpg.mvThemeCol_Button, (0.26 * 255, 0.59 * 255, 0.98 * 255, 0.15 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_ButtonHovered, (0.26 * 255, 0.59 * 255, 0.98 * 255, 0.15 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_ButtonActive, (0.26 * 255, 0.59 * 255, 0.98 * 255, 0.15 * 255)) 

            # Optional: dim text as well
            dpg.add_theme_color(dpg.mvThemeCol_Text, (150, 150, 150))
            dpg.add_theme_color(dpg.mvThemeCol_TextDisabled, (150, 150, 150))
        ...
        with dpg.theme_component(0):
            ...
            dpg.add_theme_color(dpg.mvThemeCol_PopupBg                , (1.00 * 240, 1.00 * 240, 1.00 * 240, 0.98 * 255))
